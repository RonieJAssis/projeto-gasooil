...
<body>
	...
	<label></label> 
	<div class="corpo">
	<form action="Php/CadastroPosto.php" method="POST">
	<div class="text">NOME DO POSTO</div>
	<div class="mid">
		<input type="text" style="text-align: center;" id="nomeP" name="nomeP"/>
	</div>
	<div class="text">CNPJ</div>
	<div class="mid">
		<input type="text" style="text-align: center;" id ="cnpj" name ="cnpj"/>
	</div>
